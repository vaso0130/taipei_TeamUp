...
- **內容安全**：所有使用者產生的文字發布前經過自動化風險檢測（Vertex AI Gemini，fail-closed），阻擋詐騙、釣魚、站外導流等內容。
...
- 詳見 [`docs/architecture.md`](docs/architecture.md) 與 [`docs/privacy.md`](docs/privacy.md)
